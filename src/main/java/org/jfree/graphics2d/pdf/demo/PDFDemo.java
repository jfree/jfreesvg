package org.jfree.graphics2d.pdf.demo;
...
import org.jfree.graphics2d.pdf.GraphicsStream;
...
public class PDFDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //GraphicsStream gs = pdfDoc.createGraphicsStream(page);
        //page.setContents(gs);
        PDFGraphics2D g2 = page.getGraphics2D();
        Rectangle r = new Rectangle(0, 0, 612, 468);
        chart.draw(g2, r);
        File f = new File("Test2.pdf");
